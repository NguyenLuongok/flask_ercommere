		...
		if(cart) {
			...
			jQuery.each(cart.items,function(i,item){
				...
				if(item.image != null)
					...
					tr.find('.item-image').html("<img src='//theme.hstatic.net/1000309459/1000717021/14/no_image.jpg?v=402'>");
...
function clone_item(product,i){
	...
	if ( product.image == null ) {
		item_product.find('img').attr('src','//theme.hstatic.net/1000309459/1000717021/14/no_image.jpg?v=402').attr('alt', product.url);
	} else {
